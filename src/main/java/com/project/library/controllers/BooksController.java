...
import com.project.library.services.BooksService;
import com.project.library.services.PeopleService;
...
public class BooksController {
    ...
    public String makeSearch(Model model, @RequestParam("name") String name) {
        model.addAttribute("books", booksService.searchByTitle(name));
        return "books/search";
    }
}
